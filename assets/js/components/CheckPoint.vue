                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="row">
                                <div class="card card-signup">
                                    <div class="card-body" v-if="data.products.length">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <tr v-for="(item, index) in data.products"
                                                :class="{'not-exist': !item.is_available}" :index="index">
                                                <td>{{item.name}}</td>
                                                <td>
                                        ...
                                        <p v-if="!isValidToPay">{{$t('products.not_valid')}}</p>
